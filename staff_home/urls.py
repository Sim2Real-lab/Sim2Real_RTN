...
urlpatterns = [
    ...
    path('staff/tests/<int:test_id>/questions/', manage_questions, name='manage_questions'),  # list
path('staff/tests/<int:test_id>/questions/add/', add_question, name='add_question'),      # add
path('staff/tests/questions/<int:question_id>/edit/', edit_question, name='edit_question'),  # edit
path('staff/tests/questions/<int:question_id>/delete/', delete_question, name='delete_question'),  # delete
